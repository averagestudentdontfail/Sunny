  ...
  pdf:
    ...
    include-in-header:
      text: |
        ...
        \usepackage{caption}
        \usepackage{tikz}
        \usetikzlibrary{shapes.geometric,arrows,positioning,decorations.pathreplacing,shapes,fit,backgrounds}
        % Custom colors
...
% Use the "fit" library to draw a box around the vicious cycle nodes on a background layer
\begin{scope}[on background layer]
  \node[vicious_cycle_box, fit=(C) (D) (E)] (cycle_box) {};
\end{scope}
