...
\begin{tikzpicture}[
  ...
  sensation/.style={ellipse, draw, thick, fill=orange!20, minimum height=1.2cm, text width=2.2cm},
...
\node[sensation, below=of threat] (sensations) {Bodily Sensations\\Palpitations, Dizziness};
