...
% Calculate bounding box coordinates for all vicious cycle nodes (C, D, E)
\coordinate (cycle_nw) at ([xshift=-0.7cm,yshift=0.7cm]D.north west);
\coordinate (cycle_se) at ([xshift=0.7cm,yshift=-0.7cm]C.south east);

% Draw the vicious cycle highlight box to encompass C, D, and E
\draw[thick, red, dashed, rounded corners=12pt] 
  (cycle_nw) rectangle (cycle_se);
